<%-- 
    Document   : blacklist
    Created on : Feb 8, 2022, 12:17:49 PM
    Author     : Ella
--%>
                                    ...
                                    <table class="table align-items-center table-flush">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               ...
                                               <td><span class="badge badge-danger">Blokir</span></td>
                                               <td>
                                                    <a href="hapusblacklist.jsp?kode_pemblokiran=<%=rs.getString("kode_pemblokiran")%>"><span class="btn btn-primary" name="kembali" value="kembali">Hapus</span></a>
                                                </td>
                                            </tr>
                                            </form>
                                            <% } %>
