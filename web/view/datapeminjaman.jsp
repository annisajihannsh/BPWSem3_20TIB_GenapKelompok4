<%-- 
    Document   : datapeminjaman
    Created on : Feb 10, 2022, 9:30:11 AM
    Author     : Ella
--%>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><%=rs.getString("status")%><td>
                                                    <a href="delete_pengajuan.jsp?no_induk=<%=rs.getString("no_induk")%>"><span class="btn btn-primary">Detail</span></a>
                                                </td>
                                            </tr>
                                            <% } %>
                                        </tbody>
